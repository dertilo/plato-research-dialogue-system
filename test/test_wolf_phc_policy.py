from DialogueManagement.DialoguePolicy.ReinforcementLearning.WoLFPHCPolicy import WoLFPHCPolicy
...
class TestWolfPHCPolicy(unittest.TestCase):
    ...
    def tearDownClass(cls) -> None:
        ...
        os.remove(TestWolfPHCPolicy.db_file)
        os.remove(TestWolfPHCPolicy.ontology_file)

    def setUp(self):
        ontology = Ontology(TestWolfPHCPolicy.ontology_file)
        database = DataBase(TestWolfPHCPolicy.db_file)
        self.policy = WoLFPHCPolicy(ontology=ontology, database=database)
